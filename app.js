...
const theme = ["cff", "tpg", "tl", "travys", "zvv"].includes(requestedTheme) ? requestedTheme : "cff";
...
if (theme !== "cff") document.querySelector("#page-title").textContent = `${theme === "travys" ? "TRAVYS" : theme === "zvv" ? "ZVV" : theme.toUpperCase()} public transport`;
